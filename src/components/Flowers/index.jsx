...
const Flowers = () => {
  ...
  const messageToDisplay = [
    ...
    "que peu de couple atteignent...",
    "Toi et Moi",
    "avons quasiment grandi et evoluer ensemble.",
    "Et aujourd'hui Mon désire le plus chère,",
    "",
    "C'est de fondé une famille avec toi",
    "et vieillir à tes côtés In Sha Allah.",
    "C'est aussi de tout faire",
    "pour te rendre heureuse, t'apporter le sourire",
    "Te soutenir à tout moment",
    "et t'aider à être la meilleur version de toi même",
    "Que l'on puisse contruire notre vie ensemble",
    "et faire des projets de vies",
    "Tu te rappel de notre rencontre ?",
    "",
    "Nous avons étés super fusionelle et cela,",
    "à la seconde ! dès le depart !",
    ...
    "On s'appercoit tout de suite",
    "que nous somme restés super fusionnelle",
    "Tu te rappel de nos soirées ensemnle ?",
    "",
    ...
    "à discuter,jouer, preparer nos retrouvailles et nos sorties,",
    ...
    "J'ai toujours continuer de voir le meilleur en toi",
    "",
    "Et mon amour pour toi",
    "n'a céssé de grandir",
