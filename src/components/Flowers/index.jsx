...
const Flowers = () => {
  ...
  const messageToDisplay = [
    ...
    "on s'aperçoit tout de suite que nous nous aimons",
    "et nous sommes restés super fusionnels.",
    "Tu te rappelles de nos soirées ensemble ?",
    "",
    "ce fut de merveilleux moments",
    "",
    "Des soirées entières et journées passées sur",
    "Skype, Téléphone, KakaoTalk, etc...",
    ...
    "Je me disais que pour te séduire",
    "et te faire resté amoureuse, je devais te faire rire.",
    "Mais à chaque fois que tu riais,",
    "je tombais de plus en plus amoureux.",
    ...
    "Tout comme une plante continue de grandir",
    "et montrer ses bellse fleures si on s'en occupe.",
